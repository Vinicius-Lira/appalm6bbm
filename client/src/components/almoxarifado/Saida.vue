...
<script>
import ConfirmaUsuario from '@/components/helper/ConfirmaUsuario';
import ItemSaida from '@/components/almoxarifado/ItemSaida';


    export default {
        components: {
            'confirma-usuario': ConfirmaUsuario,
            'item-saida': ItemSaida,
        },
        data: () => ({
            saida: {
                dataSaida: "",
